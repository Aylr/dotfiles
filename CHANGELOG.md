...
* `setup.sh` Stage 8 installs Claude Code and Hermes Agent via their official installers (skipped when already present; Hermes setup wizard deferred to `hermes setup`)
