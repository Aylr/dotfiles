...
# brew install emacs                      # Emacs editor

# Dev extras
# brew install pipx                       # Install Python CLI tools in isolated envs
# brew install yarn                       # JavaScript package manager
# brew install git-filter-repo            # Fast git history rewriting
# brew install typst                      # Modern document typesetting
...
# brew install --cask tabtopus            # Tab manager for macOS
